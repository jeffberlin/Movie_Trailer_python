...
dodgeball = media.Movie(
	...
	"http://static.rogerebert.com/uploads/movie/movie_poster/dodgeball-a-true-underdog-story-2004/large_iYrYVlNOZdPAWL7GXRCLMwxA9yG.jpg", # noqa
...
dumb_and_dumber = media.Movie(
	"Dumb and Dumber",
	"Two friends who try to return someone's property, but find themselves in a sticky situation",
	"http://t0.gstatic.com/images?q=tbn:ANd9GcRfKxcLRaftGDJ-q6WataYprMWOROBAhNPxuqjCUL8vaCA6ZaW1", # noqa
...
hangover = media.Movie(
	"The Hangover",
	"Three buddies wake up from a bachelor party in Las Vegas, with no memory of the previous night and the bachelor is missing",
...
waterboy = media.Movie(
	...
	"http://games.lukky.us/wp-content/uploads/imdbcache/tt0120484.jpg", # noqa
...
# Uses the fresh_tomatoes files to pull the movies and then open them in a webpage
